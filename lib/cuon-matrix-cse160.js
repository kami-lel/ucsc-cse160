...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] = other1.elements[1] * other2.elements[2] -
            other1.elements[2] * other2.elements[1];
        v3.elements[1] = -(other1.elements[0] * other2.elements[2]) +
            other1.elements[2] * other2.elements[0];
        v3.elements[2] = other1.elements[0] * other2.elements[1] -
    ...
    magnitude() {
        // Insert your code here.
        let m = Math.sqrt(this.elements[0] ** 2 + this.elements[1] ** 2 + this.elements[2] ** 2);
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        let old_mag = this.magnitude();
        this.elements[0] /= old_mag;
        this.elements[1] /= old_mag;
        this.elements[2] /= old_mag;
